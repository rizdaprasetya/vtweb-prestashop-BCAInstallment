 $(function() {  
  ...
  function setUpVisibility(){    
    var a = $("#VCI_ENABLE_INSTALLMENT").val();      
    switch(a){
      case "off":            
            ...
            hideOptions('VCI_INSTALLMENTS_MANDIRI', "class");
            hideOptions('ENABLED_MANDIRI_INSTALLMENT_off', "div");                                    
            hideOptions('VCI_INSTALLMENTS_BNI', "class");
      ...
      case "all_product":                                
            ...
            if (EnableMandiri == 1){              
              showOptions('VCI_INSTALLMENTS_MANDIRI', "class");
            } else {
              hideOptions('VCI_INSTALLMENTS_MANDIRI', "class");
            }

            if (EnableBni == 1){           
              showOptions('VCI_INSTALLMENTS_BNI', "class");
            } else {
              hideOptions('VCI_INSTALLMENTS_BNI', "class");
            }
            break;
  ...
  $("#VCI_ENABLE_INSTALLMENT").on('change', function(e, data) {       
    setUpVisibility();
  });
