...
class VeritransBcaInstallmentValidationModuleFrontController extends ModuleFrontController
{
  ...
  if ($veritrans_api_version == 2 && $veritrans_payment_method == 'vtweb')
  {
      if ($keys['isWarning']){          
          ...
          Tools::redirectLink('index.php?fc=module&module=veritransBcaInstallment&controller=warning&redirlink='.$keys['redirect_url'].'&message='.$keys['message']);
      }      
