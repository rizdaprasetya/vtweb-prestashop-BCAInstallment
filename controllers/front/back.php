...
class VeritransBcaInstallmentBackModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		$history->changeIdOrderState(Configuration::get('VCI_PAYMENT_FAILURE_STATUS_MAP'), $order_id);
		$history->add(true);
		//
